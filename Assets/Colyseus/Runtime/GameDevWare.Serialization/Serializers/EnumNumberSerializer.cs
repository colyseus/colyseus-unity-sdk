...
{
	/// <summary>
	/// Serializer for <see cref="Enum"/> types that serializes them as numbers.
	/// </summary>
	public sealed class EnumNumberSerializer : TypeSerializer
	{
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="EnumNumberSerializer"/> class.
		/// </summary>
		/// <param name="enumType">The type of the enum to serialize.</param>
